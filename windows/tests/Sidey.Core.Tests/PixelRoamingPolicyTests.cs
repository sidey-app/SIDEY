...
{
    private static readonly HashSet<Guid> s_noStops = [];
    ...
    public void ArrivalRestAndWalkingMatchMacAtEveryScale(double scale)
    {
        ...
        PixelRoamingPolicy.UpdateAfterMovement([agent], s_noStops, geometry, new Random(42), scale);
        ...
        PixelMovementSimulation.Step([agent], 1d / 30, geometry, [], s_noStops, new(), scale);
    ...
    public void ThreePointBoundaryAndStoppedMembersDoNotRetarget()
    {
        ...
        PixelRoamingPolicy.UpdateAfterMovement([agent], s_noStops, geometry, new Random(42));
    ...
    public void DisplayScaleDoesNotChangeLogicalSpeed(double scale)
    {
        ...
        {
            PixelMovementSimulation.Step([normal], 1d / 30, normalGeometry, [], s_noStops, new());
            PixelMovementSimulation.Step([scaled], 1d / 30, scaledGeometry, [], s_noStops, new(), scale);
        }
    ...
    public void BubbleSeparationKeepsHitTargetStillAndDoesNotRunNormalMovementTwice()
    {
        ...
        IReadOnlySet<Guid> separated = MessageBubbleCollisionResolver.Apply(agents,
