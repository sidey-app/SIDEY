...
public static class CachedStartupWorld
{
    ...
    private static readonly Guid s_localCharacterId = new("7d7df25e-225c-4a2d-8643-4b6681d598c1");
    ...
    public static WorldSnapshot? Create(AppPreferences preferences)
    {
        ...
        return new WorldSnapshot(null,
            [new PixelWorldMember(s_localCharacterId, ProfileValidator.NormalizeNickname(nickname),
