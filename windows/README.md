...
현재 Windows 정식 출시 버전은 `v1.0.8`입니다.
...
./scripts/windows/verify-release.ps1 `
  -Version 1.0.8 `
  -CandidateSetup ./build/windows/artifacts/SIDEY-Windows-x64-v1.0.8-Setup.exe
```
...
```powershell
Get-FileHash .\SIDEY-Windows-x64-v1.0.8-Setup.exe -Algorithm SHA256
```
