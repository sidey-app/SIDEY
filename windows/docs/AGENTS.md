...
For the full research, drafting, and validation workflow, explicitly read [`../.agents/skills/write-docs/SKILL.md`](../.agents/skills/write-docs/SKILL.md) while the Windows skills remain nested and are not reliably discovered from a root-started session.
