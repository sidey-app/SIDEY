...
Read this reference only when drafting or revising a Korean developer guide.
...
Name the responsible component when ownership matters. Prefer an active sentence that identifies who creates, observes, cancels, restores or disposes of a resource. Do not force an active construction when it makes Korean less natural.
