...
- Preserve Keychain denial and caching behavior, StoreKit transaction and entitlement ownership, SIDEY session rotation and legacy claim boundaries, Sparkle verification, and the differences between Direct and App Store products.
