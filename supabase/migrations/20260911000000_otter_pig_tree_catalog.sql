...
insert into public.commerce_products (id, display_name, product_description, character_id, entitlement_key, product_kind, catalog_item_id, sort_order, active) values
  ...
  ('character_tree', '나무', '우클릭하면 멈추고 다시 우클릭하면 걸어요. 작은 나무를 던져요.', 'pixel_tree', 'character:pixel_tree', 'character', 'pixel_tree', 70, true),
  ...
  ('throwable_wakkuball', '왁뿌볼', '크림 껍질이 와그작 갈라지는 말랑한 볼이에요.', null, 'throwable:throwable_wakkuball', 'throwable', 'throwable_wakkuball', 260, true),
