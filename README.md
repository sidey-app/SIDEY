...
[SIDEY Releases](https://github.com/sidey-app/SIDEY/releases)에서 `SIDEY-Windows-x64-v1.0.10-Setup.exe`를 받아 실행합니다.
...
### Windows · 2026년 9월 7일 · v1.0.10

- 프로필의 캐릭터·말풍선·투척물 선택 영역을 각각 5열·4열·4열로 고르게 배치하고 선택 표시와 내용을 중앙에 맞췄습니다.
- 상점에서 캐릭터·말풍선·투척물을 탭으로 전환하고, 필요할 때만 필터를 펼쳐 사용할 수 있습니다.
- 꾸미기 미리보기의 크기·말풍선·이동·투척 움직임을 실제 오버레이와 더 가깝게 맞추고 투척 시 캐릭터가 뒤집히는 문제를 수정했습니다.
- 업데이트 확인과 다운로드 진행 상태를 표시하며, 설정창을 닫아 트레이로 보내도 다운로드를 계속합니다.
