...
[SIDEY Releases](https://github.com/sidey-app/SIDEY/releases)에서 `SIDEY-Windows-x64-v1.2.0-Setup.exe`를 받아 실행합니다.
...
Windows 상점은 미리보기를 제공하며 구매 기능은 사용할 수 없습니다.
...
### Windows · 2026년 9월 10일 · v1.2.0

- 캐릭터 피격음 8종과 음소거·음량 조절을 추가했습니다.
- 10초 안에 10번 맞으면 별과 링을 표시하며 6초 동안 기절합니다.
- 장착 중 표시와 상점의 애니메이션 끄기 설정 대응을 추가했습니다.
- 앱 시작과 네트워크 단절·복구 시 오버레이와 연결 상태 표시를 개선했습니다.
- 설치기의 다국어 지원과 필수 구성 요소 설치를 개선했습니다.
