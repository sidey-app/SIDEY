...
[SIDEY Releases](https://github.com/sidey-app/SIDEY/releases)에서 `SIDEY-Windows-x64-v1.0.8-Setup.exe`를 받아 실행합니다.
...
### Windows · 2026년 9월 6일 · v1.0.8

- 보유한 말풍선과 투척물을 내 프로필에서 선택하고 기본 꾸미기로 되돌릴 수 있습니다.
- 장착한 말풍선을 메시지·타이핑 표시에 적용하고, 장착한 투척물과 미니 대포를 실제 오버레이에서 표시합니다.
- 상점에서 캐릭터 4종·말풍선 3종·투척물 3종을 확인하고 애니메이션 무대로 미리 볼 수 있습니다.
