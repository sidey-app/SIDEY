...
[SIDEY Releases](https://github.com/sidey-app/SIDEY/releases)에서 `SIDEY-Windows-x64-v1.1.0-Setup.exe`를 받아 실행합니다.
...
### Windows · 2026년 9월 7일 · v1.1.0

- 설정에서 한국어·영어·일본어를 재실행 없이 바꿀 수 있으며, 날짜와 시간은 컴퓨터 설정을 따릅니다.
- 메시지 입력창의 비정상 종료 문제를 수정하고 제목 표시줄 없이 둥근 모서리로 표시합니다.
- 캐릭터의 이동과 휴식, 투척 궤도와 대포 방향을 macOS와 맞췄습니다.
- 상점 미리보기에서 더블클릭 확대와 친구 클릭 투척을 지원하고, 투척물 표시·확대 선명도·별빛 효과를 개선했습니다.
- 업데이트 다운로드 비율과 알기 쉬운 오류 안내를 표시하고, 설치가 끝난 이전 업데이트 파일을 다음 실행 때 정리합니다.
- 프로필 꾸미기의 마우스 반응과 활성 그룹 아이콘 표시를 개선했습니다.
