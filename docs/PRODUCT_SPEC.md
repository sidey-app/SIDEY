...
- 기준 가격: 모든 상품 1,100원, 예외는 말풍선 3종·두쫀쿠·왁뿌볼 2,200원과 미니 대포 3,300원이다. 기존 거래 금액은 보존하고 App Store는 Apple의 현지 가격만 표시한다.
