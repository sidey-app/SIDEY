...
- 투척물별 피격음 8종을 사용하며 확대음은 폐기했다. 채팅 말풍선 등장음 1종은 신규 후보 3개의 청취·선택 단계다. 내 메시지 포함 여부와 기존 소리 설정에 묶을지는 구현 전에 확정한다. 시각 효과와 동일한 투척물 ID 해석·fallback을 사용하며 실제 충돌에서 한 번 재생한다. 발사·비행·확대·축소·기절·회복음은 추가하지 않는다.
