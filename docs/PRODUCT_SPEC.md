...
- 신규 비소모성 IAP 7종은 `assets/v1/new-products.json`을 기준으로 한다. 수달·돼지·눈송이·야구공은 한국 App Store 1,100원, 나무·왁뿌볼·두쫀쿠는 2,200원이다. 기존 10종을 포함하면 총 17종이다. 고유 투척물은 캐릭터 소유권에 포함한다.
