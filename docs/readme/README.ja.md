...
バグの修正、ドキュメントの改善、翻訳、キャラクター制作など、さまざまな貢献を歓迎します。
...
- キャラクターを制作する場合は、[アセット制作ガイド](../../assets/README.md)と[キャラクターアセット用PRテンプレート](../../.github/PULL_REQUEST_TEMPLATE/character_asset.md)を確認してください。有料アセットは、提出前に販売・精算条件についての相談が必要です。
...
アセットの複製・改変・再配布・商用利用の条件は、[SIDEY Paid Asset License 1.0](../../assets/PAID_ASSET_LICENSE.md)を確認してください。
