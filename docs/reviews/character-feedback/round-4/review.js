(() => {
  ...
  function candidateCard(candidate) {
    ...
    buttons.append(
      ...
      button('세 번 듣기', () => play(candidate.repeat_file, `${candidate.label} · ${candidate.repeat_interval_seconds}초 간격 3회`, [0, 1, 2].map(n => .15 + n * candidate.repeat_interval_seconds), candidate.kind), `${candidate.label} 세 번 듣기`, true),
    );
