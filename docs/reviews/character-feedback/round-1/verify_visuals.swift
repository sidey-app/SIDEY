...
for (name, frameCount, duration) in [("hamster-stun-orbit-v1.gif", 72, 2.4), ("hamster-stun-timeline-v1.gif", 216, 7.2)] {
...
for (name, width, height) in [("star-v1.png", 7, 7), ("hamster-stun-frame-8-v1.png", 64, 42), ("hamster-stun-frame-9-v1.png", 64, 42)] {
    let source = CGImageSourceCreateWithURL(root.appendingPathComponent(name) as CFURL, nil)!
